...
/**
 * Module declaration for LQIP (Low Quality Image Placeholder) imports.
 *
 * @module
 * @example
 *   import lqip from './image.png?lqip';
 *   // lqip.lqip, lqip.width, lqip.height, lqip.src
 */
declare module '*?lqip' {
  /**
   * The LQIP metadata for an image.
   * @property {string} lqip - The base64-encoded low-quality image placeholder.
...
/**
 * Augments React's HTMLAttributes interface to support the `strategy` prop for scripts.
 *
 * @module
...
declare module 'react' {
  interface HTMLAttributes<T extends HTMLScriptElement>
    ...
    /**
     * Script loading strategy for Next.js or similar frameworks.
