import { memoizeAsync } from '../../../packages/shared/decorators/memoize-async/memoize-async.ts';
import type { AsyncCache } from '../../../packages/shared/decorators/memoize-async/memoize-async.types.ts';
  ...
  it('should make sure error thrown when decorator not set on method', () => {
    try {
      ...
      (Error.isError(e))
        ...
        : expect('@memoizeAsync is applicable only on a methods.').toBe(String(e))
