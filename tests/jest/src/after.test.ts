import { after } from '../../../packages/shared/decorators/src/lib/after/after.ts';
import type { AfterFunc, AfterParams } from '../../../packages/shared/decorators/src/lib/after/after.types.ts';
  ...
  it('should make sure error thrown when decorator not set on method', () => {
    try {
      ...
      (Error.isError(e))
        ...
        : expect('@after is applicable only on a methods.').toBe(String(e));
      return;
    }
