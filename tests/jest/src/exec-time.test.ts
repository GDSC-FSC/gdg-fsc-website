import { execTime } from '../../../packages/shared/decorators/src/lib/exec-time/exec-time.ts';
import type { ExactTimeReportData } from '../../../packages/shared/decorators/src/lib/exec-time/exec-time.types.ts';
