import { rateLimit, SimpleRateLimitCounter } from './rate-limit';
import type { RateLimitAsyncCounter } from './rate-limit';
  ...
  it('should make sure error thrown when decorator not set on method', () => {
    try {
      ...
      (Error.isError(e))
        ...
        : expect('@rateLimit is applicable only on a method.').toBe(String(e))
  ...
  it('should make sure error on async and sync counters', () => {
    try {
      ...
      (Error.isError(e))
        ...
        : expect('You cant provide both rateLimitAsyncCounter and rateLimitCounter.').toBe(String(e))
    }
  });
